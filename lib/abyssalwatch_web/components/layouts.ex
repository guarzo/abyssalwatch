defmodule AbyssalwatchWeb.Layouts do
  ...
  def app(assigns) do
    ...
    <header class="navbar bg-base-200 px-4 sm:px-6 lg:px-8 shadow-sm">
      <div class="flex-1">
        <a href="/" class="flex items-center gap-2">
          ...
          <span class="text-xl font-bold">AbyssalWatch</span>
        </a>
      </div>
      
    <!-- Navigation - Phase 1: All features available to anonymous users -->
      <div class="flex-none hidden md:block">
        <ul class="menu menu-horizontal px-1 space-x-2">
          <li><a href="/search" class="btn btn-ghost btn-sm">Search</a></li>
          <li><a href="/dashboard" class="btn btn-ghost btn-sm">Dashboard</a></li>
          <li><a href="/watchlists" class="btn btn-ghost btn-sm">Watchlists</a></li>
          <li><a href="/notifications" class="btn btn-ghost btn-sm">Notifications</a></li>
        </ul>
      </div>
    ...
    <footer class="footer footer-center p-4 bg-base-200 text-base-content">
      <aside>
        <p>AbyssalWatch - EVE Online Abyssal Module Analysis Platform</p>
      </aside>
    </footer>
